...
<table cellspacing="0" border="0"> {{-- JEANS 11-12-2020 --}}
	@foreach ($articulos as $key => $value)
		@if (count($value) > 0)
			<tr>
				<td class="bc" colspan="14" height="15" align="center" valign=middle bgcolor="#9DC3E6"><b>{{$key}}</b></td>
			</tr>
			<tr>
				<td class="bc" colspan="2" height="15" align="center" valign=middle bgcolor="#9DC3E6"><b>CODIGO WB</b></td>
				<td class="bc" colspan="2" align="center" valign=middle bgcolor="#9DC3E6"><b>CANTIDAD</b></td>
				<td class="bc" colspan="2" align="center" valign=middle bgcolor="#9DC3E6"><b>DESCRIPCION</b></td>
				<td class="bc" colspan="1" align="center" valign=middle bgcolor="#9DC3E6"><b>Estado</b></td>
				<td class="bc" colspan="1" align="center" valign=middle bgcolor="#9DC3E6"><b>Fecha Despacho</b></td>
				<td class="bc" colspan="1" align="center" valign=middle bgcolor="#9DC3E6"><b>P. UNIT.</b></td>
				<td class="bc" colspan="3" align="center" valign=middle bgcolor="#9DC3E6"><b>DESCUENTO %</b></td>
				<td class="bc" colspan="2" align="center" valign=middle bgcolor="#9DC3E6"><b>TOTAL</b></td>
			</tr>
			@foreach ($value as $v)
				@if ($v['MCODDFA'] != 'Bono')
				<tr @if (isset($v['estado']) && $v['estado'] == 1) class="hl" @endif>
					...
					<td class="bc" colspan="3" align="left" valign=bottom>{{ $v['descrip'] }}</td>
